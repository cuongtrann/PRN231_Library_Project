      ...
      <div className="d-none d-lg-block">
        <div className="row g-0 mt-5">
          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              <h1> What are you been reading ?</h1>
              <p className="lead">
                The library team would love to know what you have been reading.
                Whether it is to learn a new skill or grow withing one, we will
        ...
        <div className="row g-0">
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              <h1>Or collection is always chaing!</h1>
              <p className="lead">
                Try to check in daily as our collection is always chaing! We
                work nonstop to procide the most accurate book and selection
                possible for our Luv 2 Read students! We are diligent about our
                book selection and our book selection and your books are always
