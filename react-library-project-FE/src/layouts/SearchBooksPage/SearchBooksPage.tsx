...
export const SearchBooksPage = () => {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      const baseUrl: string = "http://localhost:5000/api/books";
  ...
  const categoryField = (value: string) => {
    setCurrentPage(1);
    if (
      value.toLowerCase() === "self help" ||
      value.toLowerCase() === "minimalism" ||
      value.toLowerCase() === "productive" ||
      value.toLowerCase() === "science" ||
